...
/datum/atmosphere/lavaland
	...
	restricted_chance = 30	// SKYRAT EDIT: Disables restricted gases from rolling - Original value (30)
...
/datum/atmosphere/icemoon
	...
	restricted_chance = 20	// SKYRAT EDIT: Disables restricted gases from rolling - Original value (20)
